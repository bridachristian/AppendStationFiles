...
setting_dir = paste(getwd(),"/Setting/file_config_append/",sep = "")    # <-  This is the default folder for setting (dir_choose starts from here!). If you prefer another one chose here!
